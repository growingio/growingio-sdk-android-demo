...
package com.growingio.demo.compose.home.search
...
import com.growingio.demo.compose.model.SearchCategoryCollection
import com.growingio.demo.compose.model.SearchRepo
import com.growingio.demo.compose.model.SearchSuggestionGroup
...
private fun SearchHint() {
    Row(
        ...
        Icon(
            ...
            contentDescription = stringResource(R.string.compose_label_search)
        )
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(R.string.compose_search_jetsnack),
