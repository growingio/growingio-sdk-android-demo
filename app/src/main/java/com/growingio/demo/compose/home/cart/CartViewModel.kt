...
import com.growingio.demo.compose.model.SnackbarManager
...
class CartViewModel(
    ...
    fun increaseSnackCount(snackId: Long) {
        if (!shouldRandomlyFail()) {
            ...
            snackbarManager.showMessage(R.string.compose_cart_increase_error)
        }
    }
    ...
    fun decreaseSnackCount(snackId: Long) {
        if (!shouldRandomlyFail()) {
            ...
            snackbarManager.showMessage(R.string.compose_cart_decrease_error)
        }
    }
