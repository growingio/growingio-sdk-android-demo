...
class DebuggerServiceTest : WebServicesTest() {

    @Test
    fun webDebuggerTest() {
        val uri =
            "${GrowingAndroidJUnitRunner.URL_SCHEME}://growingio/webservice?serviceType=debugger&wsUrl=" + Uri.encode(
                wsUrl,
            )
        val intent = Intent()
        ...
        onView(ViewMatchers.withText(activity.getString(com.growingio.android.debugger.R.string.growing_debugger_exit)))
