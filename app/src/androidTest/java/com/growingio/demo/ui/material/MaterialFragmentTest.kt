...
@LargeTest
class MaterialFragmentTest : AbstractGrowingTestUnit() {

    @Before
    override fun setup() {
        super.setup()
        launchFragmentInHiltContainer<MaterialFragment>()
    }

    @Test
    fun onMaterialItemTest() {
        runEventTest(AutotrackEventType.VIEW_CLICK, onEvent = { baseEvent ->
            ...
            onView(withId(R.id.materialRv)).perform(
