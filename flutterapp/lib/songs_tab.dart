...
class _SongsTabState extends State<SongsTab> with GrowingPageStateMixin {

  @override
  String get alias => "SongsTab";
  ...
  Widget _listBuilder(BuildContext context, int index) {
    ...
    final color =
        defaultTargetPlatform == TargetPlatform.iOS ? colors[index] : colors[index].shade400;
