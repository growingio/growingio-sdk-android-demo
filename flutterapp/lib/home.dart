...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  Widget createScreenFor(ScreenSelected screenSelected, bool showNavBarExample) {
    switch (screenSelected) {
      ...
      case ScreenSelected.feature:
        return const TypographyScreen();
      case ScreenSelected.navigation:
...
final List<NavigationRailDestination> navRailDestinations = demoDestinations
    .map(
...
class RailTransition extends StatefulWidget {
  const RailTransition(
      {super.key, required this.animation, required this.backgroundColor, required this.child});
